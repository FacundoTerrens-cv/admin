            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                        $sql = "SELECT * FROM events WHERE empleado = '$empleado';";
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    while($emp = mysqli_fetch_array($consulta)){ ?>
                                        <tr>
                                            <td><?php echo $emp['nombre_cliente']?></td>
...
<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent_doctor.php">
              ...
              <option style="color:#000;" value="12:00:00-13:00:00">12:00:00-13:00:00</option>
						</select>
					</div>
				  </div>
				  <div class="form-group" style="display: none;">
