                              ...
                              <form class="form-horizontal" method="POST" action="add_horarios_back.php">
                                 ...
                                 <div class="modal-body">
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-10">
                                          <input type="text" name="hora_inicio" class="form-control" id="title" placeholder="08:00:00">
                                       </div>
                                    </div>
                                    <div class="form-group">
                                       <label for="title" class="col-sm-2 control-label">Hora Final</label>
                                       <div class="col-sm-10">
                                          <input type="text" name="hora_final" class="form-control" id="title" placeholder="09:00:00">
                                       </div>
                                    </div>
